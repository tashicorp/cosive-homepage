# Cosive — Per-page JSON-LD (Service + Breadcrumb + FAQ)

One `@graph` per page: a lean **Service** (its `provider` references the site-wide Organization by `@id`), a **BreadcrumbList**, and the page's **FAQPage** (mirrors the visible on-page FAQ). Paste a page's block into **Page settings → Custom Code → Inside `<head>`**. The `@id` references resolve against the Organization defined site-wide in `structured-data.md`, so nothing is duplicated. (FAQPage is AEO-only — Google removed FAQ rich results in May 2026 — but it's valid and cheap to include.)
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    {
      "@type": "FAQPage",
      "@id": "https://www.cosive.com/cyber-threat-intelligence#faqpage",
      "mainEntity": [
        {
          "@type": "Question",
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    {
      "@type": "FAQPage",
      "@id": "https://www.cosive.com/fraud-data-sharing#faqpage",
      "mainEntity": [
        {
          "@type": "Question",
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    {
      "@type": "FAQPage",
      "@id": "https://www.cosive.com/security-operations#faqpage",
      "mainEntity": [
        {
          "@type": "Question",
